...
- Sidebar navigation: Library, Collections, Favorites, Recently Added, Discover, Profiles, Settings
...
- MotionDock must remain open for live wallpapers to continue running.
